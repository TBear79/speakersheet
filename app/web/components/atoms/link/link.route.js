...
router.get('/components/atoms/link/link-markup', (req, res) => {
...
router.get('/components/atoms/link/link-script', (req, res) => {
  res.type('application/javascript');
  res.sendFile(path.join(__dirname, `link.js`));
});

router.get('/components/atoms/link/link-styles', (req, res) => {
  res.type('text/css');
