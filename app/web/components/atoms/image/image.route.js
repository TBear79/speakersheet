...
router.get('/components/atoms/image/image-markup', (req, res) => {
...
router.get('/components/atoms/image/image-script', (req, res) => {
  res.type('application/javascript');
  res.sendFile(path.join(__dirname, `image.js`));
});

router.get('/components/atoms/image/image-style', (req, res) => {
  res.type('text/css');
